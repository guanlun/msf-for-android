...
public class AboutAppView extends Activity {
	
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        this.setContentView(R.layout.about_app);
        
        ImageView aboutAppViewImage = (ImageView)findViewById(R.id.about_app_view_image);
